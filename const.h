...
/**** Including VREF of for different sense amplifiers combinations      ****/
//#define VBITSENSEMIN 0.08 //minimum bitline sense voltage is fixed to be 80 mV.


/****g_ip->sense_amp_type == 0  -> 250mV offset voltage of conv SA  
 *  g_ip->sense_amp_type == 1  -> 150mV offset voltage of MRSA 
 * g_ip->sense_amp_type == 2  -> 120mV offset voltage of CESA 
 * g_ip->sense_amp_type == 3  -> 80mV offset voltage of original cacti             ****/
#define VBITSENSEMIN ((g_ip->sense_amp_type == 0)?0.170:((g_ip->sense_amp_type == 1)? 0.150 :((g_ip->sense_amp_type == 2)? 0.120:((g_ip->sense_amp_type == 3)? 0.08 : 0.08))))
...
#define DFF2_LEAK_STACK_FACTOR 0.2 
#define XOR2_LEAK_STACK_FACTOR 0.2
