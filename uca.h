...
class UCA : public Component
{
  public:
    ...
    //write_driver
    double access_time_write;

    //bit_serial and paraller computations
    double access_time_imc; //start to sense amp out delay
    double access_time_adder; //compute adder delay
    double access_time_multiplier;
    double access_time_writeback; //write_back_delay
    ...
    double bit_serial_add_delay;
    double bit_serial_multiplier_delay;
    double bit_parallel_add_delay;
    double bit_parallel_multiplier_delay;
};
