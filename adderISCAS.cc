...
#include "adderISCAS.h" 

double Mat::compute_delayadder_ISCAS(double inrisetime)
{

double outrisetime ;
outrisetime = compute_adder_delay_ISCAS(outrisetime);
return outrisetime;
}

double Mat:: compute_adder_delay_ISCAS(double inrisetime)
{

int num_adderISCAS_subarray = subarray.num_cols / deg_bl_muxing;
...
double WINV7_p1    =  145 * g_ip->F_sz_um;
...
adder_area_circuit += compute_gate_area(INV, 1, WINV7_p1, WINV7_n1,  g_tp.cell_h_def);
adder_area_circuit_dff += 2 * compute_gate_area(DFF, 2, WDFF1_p1, WDFF1_n1,  g_tp.cell_h_def)* num_adderISCAS_subarray * num_subarrays_per_mat ;

adder_area_circuit_final = adder_area_circuit * num_adderISCAS_subarray * num_subarrays_per_mat ;

// Calculation of Final Leakage Power

double adderlkg_NOR1 = (I_WNOR1_n1) * NOR2_LEAK_STACK_FACTOR * num_adderISCAS_subarray * num_subarrays_per_mat;
double adderlkg_XOR1 = (I_WXOR1_n1) * XOR2_LEAK_STACK_FACTOR * num_adderISCAS_subarray * num_subarrays_per_mat;
double adderlkg_XOR2 = (I_WXOR2_n1) * XOR2_LEAK_STACK_FACTOR * num_adderISCAS_subarray * num_subarrays_per_mat;
double adderlkg_INV1 = (I_WINV1_n1) * INV_LEAK_STACK_FACTOR * num_adderISCAS_subarray * num_subarrays_per_mat;
double adderlkg_INV2 = (I_WINV2_n1) * INV_LEAK_STACK_FACTOR * num_adderISCAS_subarray * num_subarrays_per_mat;
double adderlkg_INV3 = (I_WINV3_n1) * INV_LEAK_STACK_FACTOR * num_adderISCAS_subarray * num_subarrays_per_mat;
double adderlkg_INV4 = (I_WINV4_n1) * INV_LEAK_STACK_FACTOR * num_adderISCAS_subarray * num_subarrays_per_mat;
double adderlkg_INV5 = (I_WINV5_n1) * INV_LEAK_STACK_FACTOR * num_adderISCAS_subarray * num_subarrays_per_mat;
double adderlkg_INV6 = (I_WINV6_n1) * INV_LEAK_STACK_FACTOR * num_adderISCAS_subarray * num_subarrays_per_mat;
double adderlkg_INV7 = (I_WINV7_n1) * INV_LEAK_STACK_FACTOR * num_adderISCAS_subarray * num_subarrays_per_mat;
double adderlkg_DFF1 = (I_WDFF1_n1) * DFF2_LEAK_STACK_FACTOR * num_adderISCAS_subarray * num_subarrays_per_mat;
...
power_adder.computeOp.dynamic += 0.5 *(C_load_DFF1  + C_load_INV7  + C_load_INV6  + C_load_INV5  + 
C_load_INV4  + C_load_INV3  + C_load_INV2  + C_load_INV1  + C_load_XOR2  + C_load_XOR1  + C_load_NOR1  )
* g_tp.peri_global.Vdd * g_tp.peri_global.Vdd * num_subarrays_per_mat;
// power_adder.computeOp.dynamic += 43.6475 * 1e-15 * num_adder_subarray * num_subarrays_per_mat;

//Calculation of Final Leakage Power

power_adder.computeOp.leakage += (adderlkg_DFF1 + adderlkg_INV7 + adderlkg_INV6 + adderlkg_INV5 + adderlkg_INV4 + adderlkg_INV3 + adderlkg_INV2 + 
...
adder_area = (adder_area_circuit_final + adder_area_circuit_dff);
    ...
    delay_adder_compute =  this_delay_INV1 + this_delay_INV7 + this_delay_XOR2 + this_delay_INV6 + this_delay_DFF1 + this_delay_INV4; //this has to be changed
//   delay_adder_compute = 0.43395 * 1e-9;
...
power_adder.computeOp.dynamic += 0.5 *( C_load_INV7  + C_load_INV6  + C_load_INV5  + C_load_INV3  + C_load_INV2  + C_load_INV1  + C_load_XOR2  + C_load_XOR1  + C_load_NOR1  )
* g_tp.peri_global.Vdd * g_tp.peri_global.Vdd * num_of_parallel_computations*num_subarrays_per_mat;
    // power_adder.computeOp.dynamic += (g_ip->n_bit) * 43.6475 * 1e-15 * num_of_parallel_computations* num_subarrays_per_mat;
    
    //Calculation of Final Leakage Power

power_adder.computeOp.leakage += ( adderlkg_INV7 + adderlkg_INV6 + adderlkg_INV5+ adderlkg_INV3 + adderlkg_INV2 + 
adderlkg_INV1 + adderlkg_XOR2 + adderlkg_XOR1 + adderlkg_NOR1 ) * g_tp.peri_global.Vdd; 
}
...
//         power_adder.computeOp.dynamic += 0.5 *( C_load_INV7  + C_load_INV6  + C_load_INV5  + C_load_INV3  + C_load_INV2  + C_load_INV1  + C_load_XOR2  + C_load_XOR1  + C_load_NOR1  )
//         * g_tp.peri_global.Vdd * g_tp.peri_global.Vdd * num_adderISCAS_subarray * num_subarrays_per_mat; 
