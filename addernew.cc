...
double Mat::compute_delayadder_new(double inrisetime)
{

double outrisetime ;
outrisetime = compute_adder_delay_new(outrisetime);
return outrisetime;
}

double Mat:: compute_adder_delay_new(double inrisetime)
{

int num_addernew_subarray = subarray.num_cols / deg_bl_muxing;
...
adder_area_circuit += compute_gate_area(DFF, 2, WDFF1_p1, WDFF1_n1,  g_tp.cell_h_def);
...
adder_area_circuit_dff += 2 * compute_gate_area(DFF, 2, WDFF1_p1, WDFF1_n1,  g_tp.cell_h_def)* num_addernew_subarray * num_subarrays_per_mat ;

adder_area_circuit_final = adder_area_circuit * num_addernew_subarray * num_subarrays_per_mat ;

// Calculation of Final Leakage Power

double adderlkg_NOR1 = (I_WNOR1_n1) * NOR2_LEAK_STACK_FACTOR * num_addernew_subarray * num_subarrays_per_mat;
double adderlkg_NAND1 = (I_WNAND1_n1) * NAND2_LEAK_STACK_FACTOR * num_addernew_subarray * num_subarrays_per_mat;
double adderlkg_INV1 = (I_WINV1_n1) * INV_LEAK_STACK_FACTOR * num_addernew_subarray * num_subarrays_per_mat;
//double adderlkg_NOR2 = (I_WNOR2_n1) * NOR2_LEAK_STACK_FACTOR * num_addernew_subarray * num_subarrays_per_mat;
double adderlkg_INV2 = (I_WINV2_n1) * INV_LEAK_STACK_FACTOR * num_addernew_subarray * num_subarrays_per_mat;
double adderlkg_DFF1 = (I_WDFF1_n1) * DFF2_LEAK_STACK_FACTOR * num_addernew_subarray * num_subarrays_per_mat;
double adderlkg_INV3 = (I_WINV3_n1) * INV_LEAK_STACK_FACTOR * num_addernew_subarray * num_subarrays_per_mat;
double adderlkg_INV4 = (I_WINV4_n1) * INV_LEAK_STACK_FACTOR * num_addernew_subarray * num_subarrays_per_mat;
double adderlkg_INV5 = (I_WINV5_n1) * INV_LEAK_STACK_FACTOR * num_addernew_subarray * num_subarrays_per_mat;
double adderlkg_XOR1 = (I_WXOR1_n1) * XOR2_LEAK_STACK_FACTOR * num_addernew_subarray * num_subarrays_per_mat;
double adderlkg_XOR2 = (I_WXOR2_n1) * XOR2_LEAK_STACK_FACTOR * num_addernew_subarray * num_subarrays_per_mat;
double adderlkg_INV6 = (I_WINV6_n1) * INV_LEAK_STACK_FACTOR * num_addernew_subarray * num_subarrays_per_mat;

// Calculation of Dynamic Energy and Delay


 // For NOR1
double C_load_NOR1 = drain_C_(WINV1_p1, PCH, 1, 1, g_tp.cell_h_def, is_dram)
 + drain_C_(WINV1_n1, NCH, 1, 1, g_tp.cell_h_def, is_dram)
;//temp
double rd_NOR1 = tr_R_on(WINV6_p1, NCH, 2, is_dram) ;
...
inrisetime = this_delay_NOR1/(1.0 - 0.5); 
 ...
 // For NAND1
double C_load_NAND1 = drain_C_(WINV1_p1, PCH, 1, 1, g_tp.cell_h_def, is_dram)
 + drain_C_(WINV1_n1, NCH, 1, 1, g_tp.cell_h_def, is_dram)
;//temp
double rd_NAND1 = tr_R_on(WINV6_p1, NCH, 2, is_dram) ;
...
inrisetime = this_delay_NAND1/(1.0 - 0.5); 
 ...
 // For INV1
double C_load_INV1 = drain_C_(WINV1_p1, PCH, 1, 1, g_tp.cell_h_def, is_dram)
 + drain_C_(WINV1_n1, NCH, 1, 1, g_tp.cell_h_def, is_dram)
;
...
inrisetime = this_delay_INV1/(1.0 - 0.5); 
 ...
 // For NOR2
double C_load_NOR2 = drain_C_(WINV1_p1, PCH, 1, 1, g_tp.cell_h_def, is_dram)
 + drain_C_(WINV1_n1, NCH, 1, 1, g_tp.cell_h_def, is_dram)
;//temp
double rd_NOR2 = tr_R_on(WINV1_n1, NCH, 1, is_dram) ;
...
inrisetime = this_delay_DFF1/(1.0 - 0.5); 
 ...
 // For INV3
double C_load_INV3 = drain_C_(WNOR1_p2, PCH, 1, 1, g_tp.cell_h_def, is_dram)
 ...
 + drain_C_(WNAND1_n1, NCH, 1, 1, g_tp.cell_h_def, is_dram)
...
;
double rd_INV3 = tr_R_on(WXOR2_n4, NCH, 1, is_dram) ;
...
inrisetime = this_delay_INV3/(1.0 - 0.5); 
 ...
 // For INV4
double C_load_INV4 = drain_C_(WINV1_p1, PCH, 1, 1, g_tp.cell_h_def, is_dram)
 + drain_C_(WINV1_n1, NCH, 1, 1, g_tp.cell_h_def, is_dram)
;//temp
double rd_INV4 = tr_R_on(WXOR2_n4, NCH, 1, is_dram) ;
...
;
double rd_INV5 = tr_R_on(WINV5_p1, PCH, 1, is_dram) ;
...
inrisetime = this_delay_XOR1/(1.0 - 0.5); 
 ...
 // For INV6
double C_load_INV6 = drain_C_(WINV6_n1, NCH, 1, 1, g_tp.cell_h_def, is_dram)
...
// power_adder.computeOp.dynamic = 45.37 * 1e-15 * num_adder_subarray * num_subarrays_per_mat;
...
adder_area = (adder_area_circuit_final + adder_area_circuit_dff);
    ...
    delay_adder_compute =   this_delay_INV2 + this_delay_XOR2 + this_delay_INV6 + this_delay_DFF1 + this_delay_INV4; //this has to be changed
    // delay_adder_compute = 0.324 * 1e-9;
...
power_adder.computeOp.dynamic += 0.5 *( C_load_INV6  + C_load_INV5  + C_load_INV3  + C_load_INV2  + C_load_INV1  + C_load_XOR2  + C_load_XOR1  + C_load_NOR1  )
* g_tp.peri_global.Vdd * g_tp.peri_global.Vdd *num_of_parallel_computations* num_subarrays_per_mat;

    // power_adder.computeOp.dynamic = (g_ip->n_bit) * 45.37 * 1e-15 * num_of_parallel_computations* num_subarrays_per_mat;

    //Calculation of Final Leakage Power

power_adder.computeOp.leakage += (  adderlkg_INV6 + adderlkg_INV5+ adderlkg_INV3 + adderlkg_INV2 + 
adderlkg_INV1 + adderlkg_XOR2 + adderlkg_XOR1 + adderlkg_NOR1 ) * g_tp.peri_global.Vdd; 
}
