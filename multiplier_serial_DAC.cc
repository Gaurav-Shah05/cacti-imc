...
#include "multiplier_serial_DAC.h" 

double Mat::compute_delaymultiplier_serial_DAC(double inrisetime)
{

double outrisetime ;
outrisetime = compute_multiplier_delay_serial_DAC(outrisetime);
return outrisetime;
}

double Mat:: compute_multiplier_delay_serial_DAC(double inrisetime)
{

int num_multiplier_serial_DAC_subarray = subarray.num_cols / deg_bl_muxing;
...
multiplier_area = multiplier_area * num_multiplier_serial_DAC_subarray * num_subarrays_per_mat ;

// Calculation of Final Leakage Power

double multiplierlkg_INV1 = (I_WINV1_n1) * INV_LEAK_STACK_FACTOR * num_multiplier_serial_DAC_subarray * num_subarrays_per_mat;
double multiplierlkg_INV2 = (I_WINV2_n1) * INV_LEAK_STACK_FACTOR * num_multiplier_serial_DAC_subarray * num_subarrays_per_mat;
double multiplierlkg_INV3 = (I_WINV3_n1) * INV_LEAK_STACK_FACTOR * num_multiplier_serial_DAC_subarray * num_subarrays_per_mat;
double multiplierlkg_INV4 = (I_WINV4_n1) * INV_LEAK_STACK_FACTOR * num_multiplier_serial_DAC_subarray * num_subarrays_per_mat;
double multiplierlkg_INV5 = (I_WINV5_n1) * INV_LEAK_STACK_FACTOR * num_multiplier_serial_DAC_subarray * num_subarrays_per_mat;
double multiplierlkg_INV6 = (I_WINV6_n1) * INV_LEAK_STACK_FACTOR * num_multiplier_serial_DAC_subarray * num_subarrays_per_mat;
double multiplierlkg_INV7 = (I_WINV7_n1) * INV_LEAK_STACK_FACTOR * num_multiplier_serial_DAC_subarray * num_subarrays_per_mat;
double multiplierlkg_INV8 = (I_WINV8_n1) * INV_LEAK_STACK_FACTOR * num_multiplier_serial_DAC_subarray * num_subarrays_per_mat;
double multiplierlkg_INV9 = (I_WINV9_n1) * INV_LEAK_STACK_FACTOR * num_multiplier_serial_DAC_subarray * num_subarrays_per_mat;
double multiplierlkg_DFF1 = (I_WDFF1_n1) * DFF2_LEAK_STACK_FACTOR * num_multiplier_serial_DAC_subarray * num_subarrays_per_mat;
double multiplierlkg_DFF2 = (I_WDFF2_n1) * DFF2_LEAK_STACK_FACTOR * num_multiplier_serial_DAC_subarray * num_subarrays_per_mat;
double multiplierlkg_NAND1 = (I_WNAND1_n1) * NAND2_LEAK_STACK_FACTOR * num_multiplier_serial_DAC_subarray * num_subarrays_per_mat;
double multiplierlkg_NAND2 = (I_WNAND2_n1) * NAND2_LEAK_STACK_FACTOR * num_multiplier_serial_DAC_subarray * num_subarrays_per_mat;
double multiplierlkg_NAND3 = (I_WNAND3_n1) * NAND2_LEAK_STACK_FACTOR * num_multiplier_serial_DAC_subarray * num_subarrays_per_mat;
double multiplierlkg_NAND4 = (I_WNAND4_n1) * NAND2_LEAK_STACK_FACTOR * num_multiplier_serial_DAC_subarray * num_subarrays_per_mat;
double multiplierlkg_NAND5 = (I_WNAND5_n1) * NAND2_LEAK_STACK_FACTOR * num_multiplier_serial_DAC_subarray * num_subarrays_per_mat;
double multiplierlkg_NAND6 = (I_WNAND6_n1) * NAND2_LEAK_STACK_FACTOR * num_multiplier_serial_DAC_subarray * num_subarrays_per_mat;
double multiplierlkg_NAND7 = (I_WNAND7_n1) * NAND2_LEAK_STACK_FACTOR * num_multiplier_serial_DAC_subarray * num_subarrays_per_mat;
double multiplierlkg_NAND8 = (I_WNAND8_n1) * NAND2_LEAK_STACK_FACTOR * num_multiplier_serial_DAC_subarray * num_subarrays_per_mat;
double multiplierlkg_NAND9 = (I_WNAND9_n1) * NAND2_LEAK_STACK_FACTOR * num_multiplier_serial_DAC_subarray * num_subarrays_per_mat;
double multiplierlkg_NAND10 = (I_WNAND1_n1) * NAND2_LEAK_STACK_FACTOR * num_multiplier_serial_DAC_subarray * num_subarrays_per_mat;
double multiplierlkg_NAND11 = (I_WNAND1_n1) * NAND2_LEAK_STACK_FACTOR * num_multiplier_serial_DAC_subarray * num_subarrays_per_mat;
double multiplierlkg_NAND12 = (I_WNAND1_n1) * NAND2_LEAK_STACK_FACTOR * num_multiplier_serial_DAC_subarray * num_subarrays_per_mat;
double multiplierlkg_NAND13 = (I_WNAND1_n1) * NAND2_LEAK_STACK_FACTOR * num_multiplier_serial_DAC_subarray * num_subarrays_per_mat;
double multiplierlkg_NOR1 = (I_WNOR1_n1) * NOR2_LEAK_STACK_FACTOR * num_multiplier_serial_DAC_subarray * num_subarrays_per_mat;
double multiplierlkg_XOR1 = (I_WXOR1_n1) * XOR2_LEAK_STACK_FACTOR * num_multiplier_serial_DAC_subarray * num_subarrays_per_mat;
double multiplierlkg_XOR2 = (I_WXOR2_n1) * XOR2_LEAK_STACK_FACTOR * num_multiplier_serial_DAC_subarray * num_subarrays_per_mat;
...
//delay
delay_multiplier_compute = (this_delay_XOR2 + this_delay_INV6 + this_delay_DFF1 + this_delay_INV4
+ this_delay_NAND2 + this_delay_NAND5 + this_delay_NAND7 + this_delay_NAND9  ) ;
//  delay_multiplier_compute = 0.49899 * 1e-9;

//Calculation of Final Dynamic Energy

power_multiplier.computeOp.dynamic = 0.5 *(C_load_XOR2  + C_load_XOR1  + C_load_NOR1  + C_load_NAND13  + C_load_NAND12  + C_load_NAND11  + C_load_NAND10  + C_load_NAND9  + C_load_NAND8  + C_load_NAND7  + C_load_NAND6  + C_load_NAND5  + C_load_NAND4  + C_load_NAND3  + C_load_NAND2  + C_load_NAND1  + C_load_DFF2  + C_load_DFF1  + C_load_INV9  + C_load_INV8  + C_load_INV7  + C_load_INV6  + C_load_INV5  + C_load_INV4  + C_load_INV3  + C_load_INV2  + C_load_INV1  )* g_tp.peri_global.Vdd * g_tp.peri_global.Vdd * num_multiplier_serial_DAC_subarray * num_subarrays_per_mat ; 
// power_multiplier.computeOp.dynamic =  38.75 * 1e-15 * num_multiplier_serial_DAC_subarray * num_subarrays_per_mat;
//Calculation of Final Leakage Power

power_multiplier.computeOp.leakage = (multiplierlkg_XOR2 + multiplierlkg_XOR1 + multiplierlkg_NOR1 + multiplierlkg_NAND1 + multiplierlkg_NAND1 + multiplierlkg_NAND1 + multiplierlkg_NAND1 + multiplierlkg_NAND9 + multiplierlkg_NAND8 + multiplierlkg_NAND7 + multiplierlkg_NAND6 + multiplierlkg_NAND5 + multiplierlkg_NAND4 + multiplierlkg_NAND3 + multiplierlkg_NAND2 + multiplierlkg_NAND1 + multiplierlkg_DFF2 + multiplierlkg_DFF1 + multiplierlkg_INV9 + multiplierlkg_INV8 + multiplierlkg_INV7 + multiplierlkg_INV6 + multiplierlkg_INV5 + multiplierlkg_INV4 + multiplierlkg_INV3 + multiplierlkg_INV2 + multiplierlkg_INV1 ) * g_tp.peri_global.Vdd; 
