...
double gate_C_inv (
    double width_pmos_inv,
    double width_nmos_inv,
    double is_dram
)
{

  return gate_C( width_pmos_inv + width_nmos_inv , 0 , is_dram);
}
...
{
 return  drain_C_(width_pmos_inv, PCH, 1, 1, g_tp.cell_h_def, is_dram_) + 
                        drain_C_(width_nmos_inv, NCH, 1, 1, g_tp.cell_h_def, is_dram_);
}
