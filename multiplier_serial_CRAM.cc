...
#include "multiplier_serial_CRAM.h" 

double Mat::compute_delaymultiplier_serial_CRAM(double inrisetime)
{

double outrisetime ;
outrisetime = compute_multiplier_delay_serial_CRAM(outrisetime);
return outrisetime;
}

double Mat:: compute_multiplier_delay_serial_CRAM(double inrisetime)
{

int num_multiplier_serial_CRAM_subarray = subarray.num_cols / deg_bl_muxing;
...
double WNOR2_p1    =  200 * g_ip->F_sz_um;
double WNOR2_p2    =  200 * g_ip->F_sz_um;
...
// Calculation of Area of Multiplier Circuit
 ...
 multiplier_area += compute_gate_area(NOR, 2, WNOR2_p1, WNOR2_n1,  g_tp.cell_h_def);
 multiplier_area += compute_gate_area(XOR, 4, WXOR1_p1, WXOR1_n1,  g_tp.cell_h_def);

 multiplier_area =  multiplier_area * num_multiplier_serial_CRAM_subarray * num_subarrays_per_mat ;

// Calculation of Final Leakage Power

double multiplierlkg_INV1 = (I_WINV1_n1) * INV_LEAK_STACK_FACTOR * num_multiplier_serial_CRAM_subarray * num_subarrays_per_mat;
double multiplierlkg_INV2 = (I_WINV2_n1) * INV_LEAK_STACK_FACTOR * num_multiplier_serial_CRAM_subarray * num_subarrays_per_mat;
double multiplierlkg_INV3 = (I_WINV3_n1) * INV_LEAK_STACK_FACTOR * num_multiplier_serial_CRAM_subarray * num_subarrays_per_mat;
double multiplierlkg_INV4 = (I_WINV4_n1) * INV_LEAK_STACK_FACTOR * num_multiplier_serial_CRAM_subarray * num_subarrays_per_mat;
double multiplierlkg_INV5 = (I_WINV5_n1) * INV_LEAK_STACK_FACTOR * num_multiplier_serial_CRAM_subarray * num_subarrays_per_mat;
double multiplierlkg_INV6 = (I_WINV6_n1) * INV_LEAK_STACK_FACTOR * num_multiplier_serial_CRAM_subarray * num_subarrays_per_mat;
double multiplierlkg_INV7 = (I_WINV7_n1) * INV_LEAK_STACK_FACTOR * num_multiplier_serial_CRAM_subarray * num_subarrays_per_mat;
double multiplierlkg_INV8 = (I_WINV8_n1) * INV_LEAK_STACK_FACTOR * num_multiplier_serial_CRAM_subarray * num_subarrays_per_mat;
double multiplierlkg_INV9 = (I_WINV9_n1) * INV_LEAK_STACK_FACTOR * num_multiplier_serial_CRAM_subarray * num_subarrays_per_mat;
double multiplierlkg_DFF1 = (I_WDFF1_n1) * DFF2_LEAK_STACK_FACTOR * num_multiplier_serial_CRAM_subarray * num_subarrays_per_mat;
double multiplierlkg_DFF2 = (I_WDFF2_n1) * DFF2_LEAK_STACK_FACTOR * num_multiplier_serial_CRAM_subarray * num_subarrays_per_mat;
double multiplierlkg_NAND1 = (I_WNAND1_n1) * NAND2_LEAK_STACK_FACTOR * num_multiplier_serial_CRAM_subarray * num_subarrays_per_mat;
double multiplierlkg_NAND2 = (I_WNAND2_n1) * NAND2_LEAK_STACK_FACTOR * num_multiplier_serial_CRAM_subarray * num_subarrays_per_mat;
double multiplierlkg_NAND3 = (I_WNAND3_n1) * NAND2_LEAK_STACK_FACTOR * num_multiplier_serial_CRAM_subarray * num_subarrays_per_mat;
double multiplierlkg_NAND4 = (I_WNAND4_n1) * NAND2_LEAK_STACK_FACTOR * num_multiplier_serial_CRAM_subarray * num_subarrays_per_mat;
double multiplierlkg_NAND5 = (I_WNAND5_n1) * NAND2_LEAK_STACK_FACTOR * num_multiplier_serial_CRAM_subarray * num_subarrays_per_mat;
double multiplierlkg_NAND6 = (I_WNAND6_n1) * NAND2_LEAK_STACK_FACTOR * num_multiplier_serial_CRAM_subarray * num_subarrays_per_mat;
double multiplierlkg_NAND7 = (I_WNAND7_n1) * NAND2_LEAK_STACK_FACTOR * num_multiplier_serial_CRAM_subarray * num_subarrays_per_mat;
double multiplierlkg_NAND8 = (I_WNAND8_n1) * NAND2_LEAK_STACK_FACTOR * num_multiplier_serial_CRAM_subarray * num_subarrays_per_mat;
double multiplierlkg_NAND9 = (I_WNAND9_n1) * NAND2_LEAK_STACK_FACTOR * num_multiplier_serial_CRAM_subarray * num_subarrays_per_mat;
double multiplierlkg_NAND10 = (I_WNAND1_n1) * NAND2_LEAK_STACK_FACTOR * num_multiplier_serial_CRAM_subarray * num_subarrays_per_mat;
double multiplierlkg_NAND11 = (I_WNAND1_n1) * NAND2_LEAK_STACK_FACTOR * num_multiplier_serial_CRAM_subarray * num_subarrays_per_mat;
double multiplierlkg_NAND12 = (I_WNAND1_n1) * NAND2_LEAK_STACK_FACTOR * num_multiplier_serial_CRAM_subarray * num_subarrays_per_mat;
double multiplierlkg_NAND13 = (I_WNAND1_n1) * NAND2_LEAK_STACK_FACTOR * num_multiplier_serial_CRAM_subarray * num_subarrays_per_mat;
double multiplierlkg_NAND14 = (I_WNAND1_n1) * NAND2_LEAK_STACK_FACTOR * num_multiplier_serial_CRAM_subarray * num_subarrays_per_mat;
double multiplierlkg_NOR1 = (I_WNOR1_n1) * NOR2_LEAK_STACK_FACTOR * num_multiplier_serial_CRAM_subarray * num_subarrays_per_mat;
double multiplierlkg_NOR2 = (I_WNOR2_n1) * NOR2_LEAK_STACK_FACTOR * num_multiplier_serial_CRAM_subarray * num_subarrays_per_mat;
double multiplierlkg_XOR1 = (I_WXOR1_n1) * XOR2_LEAK_STACK_FACTOR * num_multiplier_serial_CRAM_subarray * num_subarrays_per_mat;
...
;
double rd_INV1 = tr_R_on(WINV1_p1, PCH, 1, is_dram) ;
...
double C_load_INV2 = drain_C_(WINV2_p1, PCH, 1, 1, g_tp.cell_h_def, is_dram)
 ...
 + gate_C(WNOR2_p1, 0 , is_dram)
 + gate_C(WNOR2_n1, 0 , is_dram)
;
double rd_INV2 = tr_R_on(WNOR2_n1, NCH, 1, is_dram) ;
...
;
double rd_INV3 = tr_R_on(WDFF1_n2, NCH, 1, is_dram) ;
...
inrisetime = this_delay_INV3/(1.0 - 0.5); 
 ...
 // For INV4
double C_load_INV4 = gate_C(WNAND14_n2, 0 , is_dram)
...
;
double rd_INV4 = tr_R_on(WNAND2_n1, NCH, 1, is_dram) ;
...
inrisetime = this_delay_INV4/(1.0 - 0.5); 
 ...
 // For INV5
double C_load_INV5 = drain_C_(WINV5_p1, PCH, 1, 1, g_tp.cell_h_def, is_dram)
 + drain_C_(WINV5_n1, NCH, 1, 1, g_tp.cell_h_def, is_dram)
 + gate_C(WXOR1_p4, 0 , is_dram)
 + gate_C(WXOR1_n4, 0 , is_dram)
;
double rd_INV5 = tr_R_on(WXOR1_n4, NCH, 1, is_dram) ;
...
inrisetime = this_delay_INV5/(1.0 - 0.5); 
 ...
 // For INV6
double C_load_INV6 = drain_C_(WINV6_p1, PCH, 1, 1, g_tp.cell_h_def, is_dram)
 + drain_C_(WINV6_n1, NCH, 1, 1, g_tp.cell_h_def, is_dram)
 + gate_C(WNAND1_p1, 0 , is_dram)
 + gate_C(WNAND1_n1, 0 , is_dram)
;
double rd_INV6 = tr_R_on(WNAND1_n1, NCH, 1, is_dram) ;
...
inrisetime = this_delay_INV6/(1.0 - 0.5); 
 ...
 // For INV7
double C_load_INV7 = gate_C(WNAND4_p1, 0 , is_dram)
...
double C_load_INV8 = drain_C_(WINV8_p1, PCH, 1, 1, g_tp.cell_h_def, is_dram)
 ...
 + gate_C(WNAND12_p1, 0 , is_dram)
 + gate_C(WNAND12_n1, 0 , is_dram)
;
double rd_INV8 = tr_R_on(WNAND12_n1, NCH, 1, is_dram) ;
...
double C_load_NAND1 = drain_C_(WNAND1_p1, PCH, 1, 1, g_tp.cell_h_def, is_dram)
 ...
 + gate_C(WNAND5_n1, 0 , is_dram)
;
double rd_NAND1 = tr_R_on(WNAND5_n1, NCH, 2, is_dram) ;
...
;
double rd_NAND2 = tr_R_on(WNAND5_n2, NCH, 2, is_dram) ;
...
double C_load_NAND3 = drain_C_(WNAND3_p1, PCH, 1, 1, g_tp.cell_h_def, is_dram)
 ...
 + gate_C(WNAND6_p1, 0 , is_dram)
 + gate_C(WNAND6_n1, 0 , is_dram)
;
double rd_NAND3 = tr_R_on(WNAND6_n1, NCH, 2, is_dram) ;
...
double C_load_NAND4 = drain_C_(WNAND4_p1, PCH, 1, 1, g_tp.cell_h_def, is_dram)
 ...
 + gate_C(WNAND6_p2, 0 , is_dram)
 + gate_C(WNAND6_n2, 0 , is_dram)
;
double rd_NAND4 = tr_R_on(WNAND6_n2, NCH, 2, is_dram) ;
...
;
double rd_NAND6 = tr_R_on(WNAND8_n1, NCH, 2, is_dram) ;
...
double C_load_NAND8 = drain_C_(WNAND8_p1, PCH, 1, 1, g_tp.cell_h_def, is_dram)
 ...
 + gate_C(WNAND9_p2, 0 , is_dram)
 + gate_C(WNAND9_n2, 0 , is_dram)
;
double rd_NAND8 = tr_R_on(WNAND9_n2, NCH, 2, is_dram) ;
...
;
double rd_NAND9 = tr_R_on(WNAND9_n1, NCH, 2, is_dram) ;
...
inrisetime = this_delay_NAND9/(1.0 - 0.5); 
 ...
 // For NAND10
double C_load_NAND10 = gate_C(WNAND1_p2, 0 , is_dram)
 + gate_C(WNAND1_n2, 0 , is_dram)
 + gate_C(WNAND3_p2, 0 , is_dram)
 + gate_C(WNAND3_n2, 0 , is_dram)
 + drain_C_(WNAND10_p1, PCH, 1, 1, g_tp.cell_h_def, is_dram)
...
inrisetime = this_delay_NAND10/(1.0 - 0.5); 
 ...
 // For NAND11
double C_load_NAND11 = gate_C(WNAND7_p2, 0 , is_dram)
...
inrisetime = this_delay_NAND11/(1.0 - 0.5); 
 ...
 // For NAND12
double C_load_NAND12 = drain_C_(WNAND12_p1, PCH, 1, 1, g_tp.cell_h_def, is_dram)
...
;
double rd_NAND12 = tr_R_on(WNAND13_n1, NCH, 2, is_dram) ;
...
;
double rd_NAND13 = tr_R_on(WINV9_n1, NCH, 2, is_dram) ;
...
inrisetime = this_delay_NAND13/(1.0 - 0.5); 
 ...
 // For NAND14
double C_load_NAND14 = drain_C_(WNAND14_n1, NCH, 2, 1, g_tp.cell_h_def, is_dram)
 + drain_C_(WNAND14_p1, PCH, 1, 1, g_tp.cell_h_def, is_dram)
 + drain_C_(WNAND14_p2, PCH, 1, 1, g_tp.cell_h_def, is_dram)
 + gate_C(WINV2_p1, 0 , is_dram)
 + gate_C(WINV2_n1, 0 , is_dram)
;
double rd_NAND14 = tr_R_on(WINV2_n1, PCH, 1, is_dram) ;
...
;
double rd_NOR2 = tr_R_on(WINV3_n1, NCH, 1, is_dram) ;
...
;
double rd_XOR1 = tr_R_on(WINV6_n1, NCH, 2, is_dram) ;
...
//calculation delay
delay_multiplier_compute = (this_delay_NOR1 + this_delay_NAND14 + this_delay_INV2 + this_delay_NOR2 + this_delay_INV3 +
                           this_delay_DFF1 + this_delay_INV4 + this_delay_NAND2 + this_delay_NAND5 + this_delay_NAND7
                           + this_delay_NAND9 );

// delay_multiplier_compute = 0.475 * 1e-9;

//Calculation of Final Dynamic Energy

power_multiplier.computeOp.dynamic = 0.5 *(C_load_XOR1  + C_load_NOR2  + C_load_NOR1  + C_load_NAND14  + C_load_NAND13  + C_load_NAND12  + C_load_NAND11  + C_load_NAND10  + C_load_NAND9  + C_load_NAND8  + C_load_NAND7  + C_load_NAND6  + C_load_NAND5  + C_load_NAND4  + C_load_NAND3  + C_load_NAND2  + C_load_NAND1  + C_load_DFF2  + C_load_DFF1  + C_load_INV9  + C_load_INV8  + C_load_INV7  + C_load_INV6  + C_load_INV5  + C_load_INV4  + C_load_INV3  + C_load_INV2  + C_load_INV1  )* g_tp.peri_global.Vdd * g_tp.peri_global.Vdd * num_multiplier_serial_CRAM_subarray * num_subarrays_per_mat; 
// power_multiplier.computeOp.dynamic = 48.3 * 1e-15 * num_multiplier_serial_CRAM_subarray * num_subarrays_per_mat;


//Calculation of Final Leakage Power

power_multiplier.computeOp.leakage = (multiplierlkg_XOR1 + multiplierlkg_NOR2 + multiplierlkg_NOR1 + multiplierlkg_NAND1 + multiplierlkg_NAND1 + multiplierlkg_NAND1 + multiplierlkg_NAND1 + multiplierlkg_NAND1 + multiplierlkg_NAND9 + multiplierlkg_NAND8 + multiplierlkg_NAND7 + multiplierlkg_NAND6 + multiplierlkg_NAND5 + multiplierlkg_NAND4 + multiplierlkg_NAND3 + multiplierlkg_NAND2 + multiplierlkg_NAND1 + multiplierlkg_DFF2 + multiplierlkg_DFF1 + multiplierlkg_INV9 + multiplierlkg_INV8 + multiplierlkg_INV7 + multiplierlkg_INV6 + multiplierlkg_INV5 + multiplierlkg_INV4 + multiplierlkg_INV3 + multiplierlkg_INV2 + multiplierlkg_INV1 ) * g_tp.peri_global.Vdd; 
