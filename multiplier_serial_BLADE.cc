...
#include "multiplier_serial_BLADE.h" 

double Mat::compute_delaymultiplier_serial_BLADE(double inrisetime)
{

double outrisetime ;
outrisetime = compute_multiplier_delay_serial_BLADE(outrisetime);
return outrisetime;
}

double Mat:: compute_multiplier_delay_serial_BLADE(double inrisetime)
{

int num_multiplier_serial_BLADE_subarray = subarray.num_cols / deg_bl_muxing;
...
double WNOR3_p1    =  200 * g_ip->F_sz_um;
double WNOR3_p2    =  200 * g_ip->F_sz_um;
...
multiplier_area += compute_gate_area(NOR, 2, WNOR3_p1, WNOR3_n1,  g_tp.cell_h_def);
multiplier_area += compute_gate_area(XOR, 4, WXOR1_p1, WXOR1_n1,  g_tp.cell_h_def);

multiplier_area = multiplier_area * num_multiplier_serial_BLADE_subarray * num_subarrays_per_mat ;

// Calculation of Final Leakage Power

double  multiplierlkg_INV1 = (I_WINV1_n1) * INV_LEAK_STACK_FACTOR * num_multiplier_serial_BLADE_subarray * num_subarrays_per_mat;
double  multiplierlkg_INV2 = (I_WINV2_n1) * INV_LEAK_STACK_FACTOR * num_multiplier_serial_BLADE_subarray * num_subarrays_per_mat;
double  multiplierlkg_INV3 = (I_WINV3_n1) * INV_LEAK_STACK_FACTOR * num_multiplier_serial_BLADE_subarray * num_subarrays_per_mat;
double  multiplierlkg_INV4 = (I_WINV4_n1) * INV_LEAK_STACK_FACTOR * num_multiplier_serial_BLADE_subarray * num_subarrays_per_mat;
double  multiplierlkg_INV5 = (I_WINV5_n1) * INV_LEAK_STACK_FACTOR * num_multiplier_serial_BLADE_subarray * num_subarrays_per_mat;
double  multiplierlkg_INV6 = (I_WINV6_n1) * INV_LEAK_STACK_FACTOR * num_multiplier_serial_BLADE_subarray * num_subarrays_per_mat;
double  multiplierlkg_INV7 = (I_WINV7_n1) * INV_LEAK_STACK_FACTOR * num_multiplier_serial_BLADE_subarray * num_subarrays_per_mat;
double  multiplierlkg_DFF1 = (I_WDFF1_n1) * DFF2_LEAK_STACK_FACTOR * num_multiplier_serial_BLADE_subarray * num_subarrays_per_mat;
double  multiplierlkg_DFF2 = (I_WDFF2_n1) * DFF2_LEAK_STACK_FACTOR * num_multiplier_serial_BLADE_subarray * num_subarrays_per_mat;
double  multiplierlkg_NAND1 = (I_WNAND1_n1) * NAND2_LEAK_STACK_FACTOR * num_multiplier_serial_BLADE_subarray * num_subarrays_per_mat;
double  multiplierlkg_NAND2 = (I_WNAND2_n1) * NAND2_LEAK_STACK_FACTOR * num_multiplier_serial_BLADE_subarray * num_subarrays_per_mat;
double  multiplierlkg_NAND3 = (I_WNAND3_n1) * NAND2_LEAK_STACK_FACTOR * num_multiplier_serial_BLADE_subarray * num_subarrays_per_mat;
double  multiplierlkg_NAND4 = (I_WNAND4_n1) * NAND2_LEAK_STACK_FACTOR * num_multiplier_serial_BLADE_subarray * num_subarrays_per_mat;
double  multiplierlkg_NAND5 = (I_WNAND5_n1) * NAND2_LEAK_STACK_FACTOR * num_multiplier_serial_BLADE_subarray * num_subarrays_per_mat;
double  multiplierlkg_NAND6 = (I_WNAND6_n1) * NAND2_LEAK_STACK_FACTOR * num_multiplier_serial_BLADE_subarray * num_subarrays_per_mat;
double  multiplierlkg_NAND7 = (I_WNAND7_n1) * NAND2_LEAK_STACK_FACTOR * num_multiplier_serial_BLADE_subarray * num_subarrays_per_mat;
double  multiplierlkg_NAND8 = (I_WNAND8_n1) * NAND2_LEAK_STACK_FACTOR * num_multiplier_serial_BLADE_subarray * num_subarrays_per_mat;
double  multiplierlkg_NAND9 = (I_WNAND9_n1) * NAND2_LEAK_STACK_FACTOR * num_multiplier_serial_BLADE_subarray * num_subarrays_per_mat;
double  multiplierlkg_NAND10 = (I_WNAND1_n1) * NAND2_LEAK_STACK_FACTOR * num_multiplier_serial_BLADE_subarray * num_subarrays_per_mat;
double  multiplierlkg_NAND11 = (I_WNAND1_n1) * NAND2_LEAK_STACK_FACTOR * num_multiplier_serial_BLADE_subarray * num_subarrays_per_mat;
double  multiplierlkg_NAND12 = (I_WNAND1_n1) * NAND2_LEAK_STACK_FACTOR * num_multiplier_serial_BLADE_subarray * num_subarrays_per_mat;
double  multiplierlkg_NAND13 = (I_WNAND1_n1) * NAND2_LEAK_STACK_FACTOR * num_multiplier_serial_BLADE_subarray * num_subarrays_per_mat;
double  multiplierlkg_NOR1 = (I_WNOR1_n1) * NOR2_LEAK_STACK_FACTOR * num_multiplier_serial_BLADE_subarray * num_subarrays_per_mat;
double  multiplierlkg_NOR2 = (I_WNOR2_n1) * NOR2_LEAK_STACK_FACTOR * num_multiplier_serial_BLADE_subarray * num_subarrays_per_mat;
double  multiplierlkg_NOR3 = (I_WNOR3_n1) * NOR2_LEAK_STACK_FACTOR * num_multiplier_serial_BLADE_subarray * num_subarrays_per_mat;
double  multiplierlkg_XOR1 = (I_WXOR1_n1) * XOR2_LEAK_STACK_FACTOR * num_multiplier_serial_BLADE_subarray * num_subarrays_per_mat;
...
inrisetime = this_delay_INV1/(1.0 - 0.5); 
 ...
 // For INV2
double C_load_INV2 = gate_C(WNAND2_p1, 0 , is_dram)
 + gate_C(WNAND2_n1, 0 , is_dram)
 + gate_C(WNOR2_p2, 0 , is_dram)
...
inrisetime = this_delay_INV3/(1.0 - 0.5); 
 ...
 // For INV4
double C_load_INV4 = gate_C(WNAND1_p1, 0 , is_dram)
...
inrisetime = this_delay_INV4/(1.0 - 0.5); 
 ...
 // For INV5
double C_load_INV5 = gate_C(WNAND4_p1, 0 , is_dram)
...
;
double rd_INV5 = tr_R_on(WINV6_n1, NCH, 1, is_dram) ;
...
;
double rd_INV6 = tr_R_on(WNAND12_n1, NCH, 1, is_dram) ;
...
inrisetime = this_delay_INV6/(1.0 - 0.5); 
 ...
 // For INV7
double C_load_INV7 = drain_C_(WINV7_p1, PCH, 1, 1, g_tp.cell_h_def, is_dram)
 + drain_C_(WINV7_n1, NCH, 1, 1, g_tp.cell_h_def, is_dram)
;
double rd_INV7 = tr_R_on(WINV7_n1, NCH, 1, is_dram) ;
...
;
double rd_NAND13 = tr_R_on(WINV7_n1, NCH, 2, is_dram) ;
...
delay_multiplier_compute = (this_delay_NOR1 + this_delay_INV1 + this_delay_XOR1 + this_delay_INV4 + this_delay_NAND1 + this_delay_NAND5
                    + this_delay_NAND7 +this_delay_NAND9) ;

delay_multiplier_compute = (this_delay_NOR2 + this_delay_NOR3 + this_delay_DFF1 + this_delay_INV2 +
this_delay_NAND2 + this_delay_NAND5 + this_delay_NAND7 + this_delay_NAND9);

// delay_multiplier_compute = 0.454 * 1e-9; 

//Calculation of Final Dynamic Energy

power_multiplier.computeOp.dynamic = 0.5 *(C_load_XOR1  + C_load_NOR3  + C_load_NOR2  + C_load_NOR1  
+ C_load_NAND13  + C_load_NAND12  + C_load_NAND11  + C_load_NAND10  + C_load_NAND9  
+ C_load_NAND8  + C_load_NAND7  + C_load_NAND6  + C_load_NAND5  + C_load_NAND4  
+ C_load_NAND3  + C_load_NAND2  + C_load_NAND1  + C_load_DFF2  + C_load_DFF1  
+ C_load_INV7  + C_load_INV6  + C_load_INV5  + C_load_INV4  + C_load_INV3  
+ C_load_INV2  + C_load_INV1  )* g_tp.peri_global.Vdd * g_tp.peri_global.Vdd * num_multiplier_serial_BLADE_subarray * num_subarrays_per_mat; 
// power_multiplier.computeOp.dynamic = 43.17 * 1e-15 * num_multiplier_serial_BLADE_subarray * num_subarrays_per_mat;

//Calculation of Final Leakage Power

power_multiplier.computeOp.leakage = ( multiplierlkg_XOR1 +  multiplierlkg_NOR3 
+  multiplierlkg_NOR2 +  multiplierlkg_NOR1 +  multiplierlkg_NAND1 
+  multiplierlkg_NAND1 +  multiplierlkg_NAND1 +  multiplierlkg_NAND1 
+  multiplierlkg_NAND9 +  multiplierlkg_NAND8 +  multiplierlkg_NAND7 
+  multiplierlkg_NAND6 +  multiplierlkg_NAND5 +  multiplierlkg_NAND4 
+  multiplierlkg_NAND3 +  multiplierlkg_NAND2 +  multiplierlkg_NAND1 
+  multiplierlkg_DFF2 +  multiplierlkg_DFF1 +  multiplierlkg_INV7 
+  multiplierlkg_INV6 +  multiplierlkg_INV5 +  multiplierlkg_INV4 
