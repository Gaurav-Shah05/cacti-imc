...
#include "multiplier_serial_ISCAS.h" 

double Mat::compute_delaymultiplier_serial_ISCAS(double inrisetime)
{

double outrisetime ;
outrisetime = compute_multiplier_delay_serial_ISCAS(outrisetime);
return outrisetime;
}

double Mat:: compute_multiplier_delay_serial_ISCAS(double inrisetime)
{

int num_multiplier_serial_ISCAS_subarray = subarray.num_cols / deg_bl_muxing;
...
double I_WINV10_p1 = simplified_pmos_leakage(WINV10_p1, is_dram);
...
double I_WINV10_n1 = simplified_nmos_leakage(WINV10_n1, is_dram);
...
multiplier_area += compute_gate_area(INV, 1, WINV10_p1, WINV10_n1,  g_tp.cell_h_def);
...
multiplier_area = multiplier_area * num_multiplier_serial_ISCAS_subarray * num_subarrays_per_mat ;

// Calculation of Final Leakage Power

double  multiplierlkg_INV1 = (I_WINV1_n1) * INV_LEAK_STACK_FACTOR * num_multiplier_serial_ISCAS_subarray * num_subarrays_per_mat;
double  multiplierlkg_INV2 = (I_WINV2_n1) * INV_LEAK_STACK_FACTOR * num_multiplier_serial_ISCAS_subarray * num_subarrays_per_mat;
double  multiplierlkg_INV3 = (I_WINV3_n1) * INV_LEAK_STACK_FACTOR * num_multiplier_serial_ISCAS_subarray * num_subarrays_per_mat;
double  multiplierlkg_INV4 = (I_WINV4_n1) * INV_LEAK_STACK_FACTOR * num_multiplier_serial_ISCAS_subarray * num_subarrays_per_mat;
double  multiplierlkg_INV5 = (I_WINV5_n1) * INV_LEAK_STACK_FACTOR * num_multiplier_serial_ISCAS_subarray * num_subarrays_per_mat;
double  multiplierlkg_INV6 = (I_WINV6_n1) * INV_LEAK_STACK_FACTOR * num_multiplier_serial_ISCAS_subarray * num_subarrays_per_mat;
double  multiplierlkg_INV7 = (I_WINV7_n1) * INV_LEAK_STACK_FACTOR * num_multiplier_serial_ISCAS_subarray * num_subarrays_per_mat;
double  multiplierlkg_INV8 = (I_WINV8_n1) * INV_LEAK_STACK_FACTOR * num_multiplier_serial_ISCAS_subarray * num_subarrays_per_mat;
double  multiplierlkg_INV9 = (I_WINV9_n1) * INV_LEAK_STACK_FACTOR * num_multiplier_serial_ISCAS_subarray * num_subarrays_per_mat;
double  multiplierlkg_INV10 = (I_WINV1_n1) * INV_LEAK_STACK_FACTOR * num_multiplier_serial_ISCAS_subarray * num_subarrays_per_mat;
double  multiplierlkg_DFF1 = (I_WDFF1_n1) * DFF2_LEAK_STACK_FACTOR * num_multiplier_serial_ISCAS_subarray * num_subarrays_per_mat;
double  multiplierlkg_DFF2 = (I_WDFF2_n1) * DFF2_LEAK_STACK_FACTOR * num_multiplier_serial_ISCAS_subarray * num_subarrays_per_mat;
double  multiplierlkg_NAND1 = (I_WNAND1_n1) * NAND2_LEAK_STACK_FACTOR * num_multiplier_serial_ISCAS_subarray * num_subarrays_per_mat;
double  multiplierlkg_NAND2 = (I_WNAND2_n1) * NAND2_LEAK_STACK_FACTOR * num_multiplier_serial_ISCAS_subarray * num_subarrays_per_mat;
double  multiplierlkg_NAND3 = (I_WNAND3_n1) * NAND2_LEAK_STACK_FACTOR * num_multiplier_serial_ISCAS_subarray * num_subarrays_per_mat;
double  multiplierlkg_NAND4 = (I_WNAND4_n1) * NAND2_LEAK_STACK_FACTOR * num_multiplier_serial_ISCAS_subarray * num_subarrays_per_mat;
double  multiplierlkg_NAND5 = (I_WNAND5_n1) * NAND2_LEAK_STACK_FACTOR * num_multiplier_serial_ISCAS_subarray * num_subarrays_per_mat;
double  multiplierlkg_NAND6 = (I_WNAND6_n1) * NAND2_LEAK_STACK_FACTOR * num_multiplier_serial_ISCAS_subarray * num_subarrays_per_mat;
double  multiplierlkg_NAND7 = (I_WNAND7_n1) * NAND2_LEAK_STACK_FACTOR * num_multiplier_serial_ISCAS_subarray * num_subarrays_per_mat;
double  multiplierlkg_NAND8 = (I_WNAND8_n1) * NAND2_LEAK_STACK_FACTOR * num_multiplier_serial_ISCAS_subarray * num_subarrays_per_mat;
double  multiplierlkg_NAND9 = (I_WNAND9_n1) * NAND2_LEAK_STACK_FACTOR * num_multiplier_serial_ISCAS_subarray * num_subarrays_per_mat;
double  multiplierlkg_NAND10 = (I_WNAND1_n1) * NAND2_LEAK_STACK_FACTOR * num_multiplier_serial_ISCAS_subarray * num_subarrays_per_mat;
double  multiplierlkg_NAND11 = (I_WNAND1_n1) * NAND2_LEAK_STACK_FACTOR * num_multiplier_serial_ISCAS_subarray * num_subarrays_per_mat;
double  multiplierlkg_NAND12 = (I_WNAND1_n1) * NAND2_LEAK_STACK_FACTOR * num_multiplier_serial_ISCAS_subarray * num_subarrays_per_mat;
double  multiplierlkg_NAND13 = (I_WNAND1_n1) * NAND2_LEAK_STACK_FACTOR * num_multiplier_serial_ISCAS_subarray * num_subarrays_per_mat;
double  multiplierlkg_NOR1 = (I_WNOR1_n1) * NOR2_LEAK_STACK_FACTOR * num_multiplier_serial_ISCAS_subarray * num_subarrays_per_mat;
double  multiplierlkg_XOR1 = (I_WXOR1_n1) * XOR2_LEAK_STACK_FACTOR * num_multiplier_serial_ISCAS_subarray * num_subarrays_per_mat;
double  multiplierlkg_XOR2 = (I_WXOR2_n1) * XOR2_LEAK_STACK_FACTOR * num_multiplier_serial_ISCAS_subarray * num_subarrays_per_mat;

// Calculation of Dynamic Energy and Delay


 // For INV1
double C_load_INV1 = gate_C(WINV7_p1, 0 , is_dram)
...
;
double rd_INV2 = tr_R_on(WXOR2_n2, NCH, 1, is_dram) ;
...
inrisetime = this_delay_INV2/(1.0 - 0.5); 
 ...
 // For INV3
double C_load_INV3 = gate_C(WNAND1_p1, 0 , is_dram)
 + gate_C(WNAND1_n1, 0 , is_dram)
 + drain_C_(WINV3_p1, PCH, 1, 1, g_tp.cell_h_def, is_dram)
...
inrisetime = this_delay_INV3/(1.0 - 0.5); 
 ...
 // For INV4
double C_load_INV4 = gate_C(WNAND2_p1, 0 , is_dram)
...
;
double rd_INV4 = tr_R_on(WXOR2_n3, NCH, 1, is_dram) ;
...
;
double rd_INV6 = tr_R_on(WINV6_n1, NCH, 1, is_dram) ;
...
inrisetime = this_delay_INV6/(1.0 - 0.5); 
 ...
 // For INV7
double C_load_INV7 = gate_C(WXOR2_p1, 0 , is_dram)
 + drain_C_(WINV7_p1, PCH, 1, 1, g_tp.cell_h_def, is_dram)
 + drain_C_(WINV7_n1, NCH, 1, 1, g_tp.cell_h_def, is_dram)
 + gate_C(WXOR2_n1, 0 , is_dram)
;
double rd_INV7 = tr_R_on(WXOR2_n1, NCH, 1, is_dram) ;
...
inrisetime = this_delay_INV7/(1.0 - 0.5); 
 ...
 // For INV8
double C_load_INV8 = gate_C(WNAND4_p1, 0 , is_dram)
 + gate_C(WNAND4_n1, 0 , is_dram)
 + drain_C_(WINV8_p1, PCH, 1, 1, g_tp.cell_h_def, is_dram)
...
;
double rd_INV8 = tr_R_on(WINV9_n1, NCH, 1, is_dram) ;
...
;
double rd_INV9 = tr_R_on(WNAND12_n1, NCH, 1, is_dram) ;
...
inrisetime = this_delay_INV9/(1.0 - 0.5); 
 ...
 // For INV10
double C_load_INV10 = drain_C_(WINV10_p1, PCH, 1, 1, g_tp.cell_h_def, is_dram)
 + drain_C_(WINV10_n1, NCH, 1, 1, g_tp.cell_h_def, is_dram)
;
double rd_INV10 = tr_R_on(WINV10_n1, NCH, 1, is_dram) ;
double tf_INV10 = rd_INV10 * (C_load_INV10); 
double this_delay_INV10 = horowitz(inrisetime, tf_INV10, 0.5, 0.5, RISE) ;
inrisetime = this_delay_INV10/(1.0 - 0.5); 
...
double C_load_NAND13 = drain_C_(WNAND13_p1, PCH, 1, 1, g_tp.cell_h_def, is_dram)
 ...
 + gate_C(WINV10_p1, 0 , is_dram)
 + drain_C_(WNAND13_n1, NCH, 2, 1, g_tp.cell_h_def, is_dram)
 + gate_C(WINV10_n1, 0 , is_dram)
;
double rd_NAND13 = tr_R_on(WINV10_n1, NCH, 2, is_dram) ;
...
;
double rd_NOR1 = tr_R_on(WXOR2_n4, NCH, 1, is_dram) ;
...
;
double rd_XOR2 = tr_R_on(WINV6_n1, NCH, 2, is_dram) ;
...
delay_multiplier_compute = (this_delay_NOR1 + this_delay_INV2 + this_delay_XOR1 + this_delay_INV3 
                + this_delay_NAND1 + this_delay_NAND5 + this_delay_NAND7 + this_delay_NAND9 );

delay_multiplier_compute = (this_delay_INV1 + this_delay_XOR2 +  this_delay_INV6+  this_delay_DFF1 +
this_delay_INV4 +  this_delay_NAND2 +  this_delay_NAND5 +  this_delay_NAND7 + this_delay_NAND9) ;

// delay_multiplier_compute = 0.49795 * 1e-9;



//Calculation of Final Dynamic Energy

power_multiplier.computeOp.dynamic = 0.5 *(C_load_XOR2  + C_load_XOR1  + C_load_NOR1  
...
+ C_load_NAND1  + C_load_DFF2  + C_load_DFF1  + C_load_INV10  + C_load_INV9  + C_load_INV8  
+ C_load_INV7  + C_load_INV6  + C_load_INV5  + C_load_INV4  + C_load_INV3  + C_load_INV2  
+ C_load_INV1  )* g_tp.peri_global.Vdd * g_tp.peri_global.Vdd * num_multiplier_serial_ISCAS_subarray * num_subarrays_per_mat; 
// power_multiplier.computeOp.dynamic = 43.6475 * 1e-15 * num_multiplier_serial_ISCAS_subarray * num_subarrays_per_mat;
...
+  multiplierlkg_NAND9 +  multiplierlkg_NAND8 +  multiplierlkg_NAND7 +  multiplierlkg_NAND6 
+  multiplierlkg_NAND5 +  multiplierlkg_NAND4 +  multiplierlkg_NAND3 +  multiplierlkg_NAND2 
+  multiplierlkg_NAND1 +  multiplierlkg_DFF2 +  multiplierlkg_DFF1 +  multiplierlkg_INV10 
