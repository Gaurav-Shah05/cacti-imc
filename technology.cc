...
void init_tech_params(double technology, bool is_tag)
{
  ...
  for (iter = 0; iter <= 1; ++iter)
  {
    ...
    //cout<<"tech_lo :"<<tech_lo<<endl;
    //cout<<"tech_hi :"<<tech_hi<<endl;
    //cout<<"tech :"<<tech<<endl;
    ...
    { //65nm technology-node. Corresponds to year 2007 in ITRS
      ...
      t_ox[0] = 2.6e-3;
      v_th[0] = 0.32923;
      c_ox[0] = 2.57e-14;//F/um2
      mobility_eff[0] = 196 * (1e-2 * 1e6 * 1e-2 * 1e6); 
      Vdsat[0] = 0.4633; 
      c_g_ideal[0] = 1.63e-15;
      c_fringe[0] = 9.6e-17;
      c_junc[0] = 1.2e-15;
      I_on_n[0] = 7.78e-4;
      I_on_p[0] = 3.53e-4;
      nmos_effective_resistance_multiplier = 1;
      n_to_p_eff_curr_drv_ratio[0] = 2.21;
      ...
      I_off_n[0][0]  = 1.01e-9;
      I_off_n[0][10] = 1.66e-9;
      I_off_n[0][20] = 2.65e-9;
      I_off_n[0][30] = 4.09e-9;
      I_off_n[0][40] = 6.13e-9;
      I_off_n[0][50] = 8.96e-9;
      I_off_n[0][60] = 1.28e-8;
      I_off_n[0][70] = 1.78e-8;
      I_off_n[0][80] = 2.43e-8;
      I_off_n[0][90] = 3.25e-8;
      I_off_n[0][100] = 4.27e-8;
    ...
    if (tech == 28) ///changed tech==32 to tech ==28 yash
    {
      SENSE_AMP_D = .03e-9; // s
      ...
      Lelec[0] = 0.03;
      t_ox[0] = 1.56e-3;
      v_th[0] = 0.3358;//0.3264
      c_ox[0] = 3.84e-14;//3.93e-14
      mobility_eff[0] = 176 *(1e-2 * 1e6 * 1e-2 * 1e6); 
      Vdsat[0] = 36.52E-2; //36.8E-2
      c_g_ideal[0] = 1.74e-15;
      c_fringe[0] = 1.36e-16;
      c_junc[0] = 8.38e-16;//1.5e-15;
      I_on_n[0] =  10.6e-4; //14.8e-4;
      I_on_p[0] = 7.08e-4; //10.5e-4;
      nmos_effective_resistance_multiplier = 1;//1.49 changed by yash
      n_to_p_eff_curr_drv_ratio[0] = 1.49; 
      gmp_to_gmn_multiplier[0] = 1.31997;
      Rnchannelon[0] = nmos_effective_resistance_multiplier * vdd[0] / I_on_n[0];//ohm-micron
      Rpchannelon[0] = n_to_p_eff_curr_drv_ratio[0] * Rnchannelon[0];//ohm-micron
      I_off_n[0][0] =  2.01e-8;
      I_off_n[0][10] = 2.97e-8;
      I_off_n[0][20] = 4.28e-8;
      I_off_n[0][30] = 6.03e-8;
      I_off_n[0][40] = 8.31e-8;
      I_off_n[0][50] = 1.12e-7;
      I_off_n[0][60] = 1.49e-7;
      I_off_n[0][70] = 1.95e-7;
      I_off_n[0][80] = 2.50e-7;
      I_off_n[0][90] = 3.18e-7;
      I_off_n[0][100] = 3.98e-7;
      ...
      // t_ox[0] = 1.56e-3;
      // v_th[0] = 0.3264;
      // c_ox[0] = 3.93e-14;//1.18e-14;
      // mobility_eff[0] = 176 *(1e-2 * 1e6 * 1e-2 * 1e6); 
      // Vdsat[0] = 36.8E-2; 
      // c_g_ideal[0] = 1.17e-15;
      // c_fringe[0] = 1.36e-16;
      // c_junc[0] = 1.5e-15;//4.5e-18;
      // I_on_n[0] =  14.8e-4; //14.8e-4;
      // I_on_p[0] = 10.5e-4; //10.5e-4;
      // nmos_effective_resistance_multiplier = 1.0489;
      // n_to_p_eff_curr_drv_ratio[0] = 1.41;
      // gmp_to_gmn_multiplier[0] = 1.334;
      // Rnchannelon[0] = nmos_effective_resistance_multiplier * vdd[0] / I_on_n[0];//ohm-micron
      // Rpchannelon[0] = n_to_p_eff_curr_drv_ratio[0] * Rnchannelon[0];//ohm-micron
      // I_off_n[0][0] =  3.02e-8;
      // I_off_n[0][10] = 4.38e-8;
      // I_off_n[0][20] = 6.21e-8;
      // I_off_n[0][30] = 8.60e-8;//
      // I_off_n[0][40] = 1.17e-7;
      // I_off_n[0][50] = 1.56e-7;
      // I_off_n[0][60] = 2.04e-7;
      // I_off_n[0][70] = 2.63e-7;
      // I_off_n[0][80] = 3.34e-7;
      // I_off_n[0][90] = 4.19e-7;
      // I_off_n[0][100] = 5.20e-7;
...
//    g_tp.max_w_nmos_ = 100 * g_ip->F_sz_um; 
    ...
    for (iter=0; iter<=1; ++iter)
    {
      ...
      else if (tech == 28) //changed 32 to 28 yash
      {
        //Aggressive projections.
        wire_pitch[0][0] = 2.5 * g_ip->F_sz_um;
        aspect_ratio = 3.0;
